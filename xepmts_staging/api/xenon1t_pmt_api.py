...
class Xenon1tPmtApi(object):
    ...
    def get_xenon1t_pmts(self, **kwargs):  # noqa: E501
        """Retrieves one or more Xenon1tPmts  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_xenon1t_pmts(async_req=True)
        >>> result = thread.get()
        ...
        return self.get_xenon1t_pmts_with_http_info(**kwargs)  # noqa: E501

    def get_xenon1t_pmts_with_http_info(self, **kwargs):  # noqa: E501
        """Retrieves one or more Xenon1tPmts  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_xenon1t_pmts_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method get_xenon1t_pmts" % key
                )
