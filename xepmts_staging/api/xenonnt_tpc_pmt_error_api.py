...
class XenonntTpcPmtErrorApi(object):
    ...
    def get_xenonnt_tpc_pmt_errors(self, **kwargs):  # noqa: E501
        """Retrieves one or more XenonntTpcPmtErrors  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_xenonnt_tpc_pmt_errors(async_req=True)
        >>> result = thread.get()
        ...
        return self.get_xenonnt_tpc_pmt_errors_with_http_info(**kwargs)  # noqa: E501

    def get_xenonnt_tpc_pmt_errors_with_http_info(self, **kwargs):  # noqa: E501
        """Retrieves one or more XenonntTpcPmtErrors  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_xenonnt_tpc_pmt_errors_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method get_xenonnt_tpc_pmt_errors" % key
                )
