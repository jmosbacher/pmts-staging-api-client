...
class XenonntAfterpulseApi(object):
    ...
    def get_xenonnt_afterpulses(self, **kwargs):  # noqa: E501
        """Retrieves one or more XenonntAfterpulses  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_xenonnt_afterpulses(async_req=True)
        >>> result = thread.get()
        ...
        return self.get_xenonnt_afterpulses_with_http_info(**kwargs)  # noqa: E501

    def get_xenonnt_afterpulses_with_http_info(self, **kwargs):  # noqa: E501
        """Retrieves one or more XenonntAfterpulses  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_xenonnt_afterpulses_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method get_xenonnt_afterpulses" % key
                )
